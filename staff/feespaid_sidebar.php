	 ...
	 <div class="span3" id="sidebar">
                  ...
                  <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
						 ...
						 <li>						
                           ...
                           <li class="">
                            <a href="#detailmanage" data-toggle="modal"><i class="icon-chevron-right"></i><i class="icon-user"></i> Stundents Details</a>
                            </li>
					    ...
					    <li>						
						    ...
						    <ul id="bs1" class="collapse">						
                             <li class="">
                            <a href="#detailModal" data-toggle="modal" tabindex="1"><i class="icon-chevron-right"></i><i class="icon-file"></i> Pay Fees</a>
                            </li>
							<li class="">
                            <a href="#detailfee" data-toggle="modal"><i class="icon-chevron-right"></i><i class="icon-file"></i> Paid Fees</a>
                            </li>
						    <li class="">
                            <a href="#detailbalance" data-toggle="modal"><i class="icon-chevron-right"></i><i class="icon-file"></i> Fees Balances</a>
                            </li>
					  ...
					  <!------/.* notification sidebar*------->
                        ...
                        <li class="active">
                           ...
                           <li>
                           <a href="#myModal" data-toggle="modal" tabindex="1"><i class="icon-chevron-right"></i><i class="icon-search"></i>&nbsp;Student</a>
                           </li>
